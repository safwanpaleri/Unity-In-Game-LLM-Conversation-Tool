...
using static GeminiAgent;

public class MistralAgent : MonoBehaviour
{
    ...
    [HideInInspector] public List<RequestContent> requestContents = new List<RequestContent>();
    ...
    private void Start()
    {
        ...
        // Initial instruction for mistral to behave as a specific character in group conversation
        initialContent = "act as a " + characterDescription + ", named as " + characterName +
            ...
            "the other characters are " + otherCharactersNames + ". and only include emotion and dailogue no action just like the examples, also don't include the speaker name at start, only one emotion and dialogue allowed at a time";
    }
    ...
    /// <summary>
    /// Public function to call from any script to generate dailogue using mistral.
    /// </summary>
    ...
    IEnumerator SpeakWithGemini()
    {
        ...
        RequestContentTTS[] requestContents = new RequestContentTTS[1];
        requestContents[0] = new RequestContentTTS();
