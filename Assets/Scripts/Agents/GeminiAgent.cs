...
public class GeminiAgent : MonoBehaviour
{
    ...
    [System.Serializable]
    public class RequestBodyConversation
    {
        public RequestContentConversation[] contents;
    }

    [System.Serializable]
    public class RequestContentConversation
    {
        public PartConversation[] parts;
    }

    [System.Serializable]
    public class PartConversation
    {
        public string text;
    }
    ...
    {
        public RequestContentConversation content;
    }
    ...
    [HideInInspector] public string message = string.Empty;
    [HideInInspector] public List<PartConversation> conversationParts;
    ...
    private void Start()
    {
        ...
        // Initial instruction for gemini to behave as a specific character in group conversation
    ...
    /// <summary>
    /// Public function to call from any script to generate dailogue using gemini.
    /// </summary>
    ...
    public void GenerateNextDailogue(List<string> conversationHistory, string additionalContent = "")
    {
        ...
        conversationParts.Add(new PartConversation { text = initialContent + '\n' + AdditionalPrompt });
        foreach (var conversation in conversationHistory)
        {
            conversationParts.Add(new PartConversation { text=conversation});
        }
        if(additionalContent != "")
            conversationParts.Add(new PartConversation { text =  additionalContent });
    ...
    private IEnumerator SendRequest()
    {
         ...
         */
        RequestBodyConversation requestBody = new RequestBodyConversation();
        var requestContent = new RequestContentConversation();
        requestContent.parts = conversationParts.ToArray();
        requestBody.contents = new RequestContentConversation[1];
        ...
        request.SetRequestHeader("RequestContentConversation-Type", "application/json");
    ...
    public void GenerateModeratorContent(string Content)
    {
        ...
        isCompleted = false;
        conversationParts.Clear();
        conversationParts.Add(new PartConversation { text = Content });
        StartCoroutine(SendRequest());
    }
