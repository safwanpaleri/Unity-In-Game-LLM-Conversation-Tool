...
public class DeepSeekAutomatedTesting : MonoBehaviour
{
    [System.Serializable]
    ...
    [Header("Agents")]
    [SerializeField] private DeepSeekAgent chatgptAgent;
    [SerializeField] private DeepSeekAgent geminiAgent;
    [SerializeField] private DeepSeekAgent claudeAgent;
    [SerializeField] private DeepSeekAgent deepSeekAgent;
    [SerializeField] private DeepSeekAgent mistralAgent;
    ...
    void Start()
    {
        evaluatedfilename = Path.Combine(Application.dataPath, "Testcases/evaluationData_DeepSeek.json");
    ...
    private void SetupBarChart()
    {
        ...
        foreach (var data in evaluationdataList.dataList)
        {
            i++;
            barChart.AddXAxisData(i.ToString());
            float avg = float.Parse(data.DeepseekAvgTime);
