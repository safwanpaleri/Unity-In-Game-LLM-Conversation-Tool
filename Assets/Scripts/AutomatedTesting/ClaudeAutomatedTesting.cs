...
public class ClaudeAutomatedTesting : MonoBehaviour
{
    [System.Serializable]
    ...
    [Header("Agents")]
    [SerializeField] private ClaudeAgent chatgptAgent;
    [SerializeField] private ClaudeAgent geminiAgent;
    [SerializeField] private ClaudeAgent claudeAgent;
    [SerializeField] private ClaudeAgent deepSeekAgent;
    [SerializeField] private ClaudeAgent mistralAgent;
    ...
    void Start()
    {
        evaluatedfilename = Path.Combine(Application.dataPath, "Testcases/evaluationData_Claude.json");
    ...
    private void SetupBarChart()
    {
        ...
        foreach (var data in evaluationdataList.dataList)
        {
            i++;
            barChart.AddXAxisData(i.ToString());
            float avg = float.Parse(data.ClaudeAvgTime);
