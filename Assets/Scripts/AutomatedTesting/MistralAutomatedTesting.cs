...
public class MistralAutomatedTesting : MonoBehaviour
{
    [System.Serializable]
    ...
    [Header("Agents")]
    [SerializeField] private MistralAgent chatgptAgent;
    [SerializeField] private MistralAgent geminiAgent;
    [SerializeField] private MistralAgent claudeAgent;
    [SerializeField] private MistralAgent deepSeekAgent;
    ...
    void Start()
    {
        evaluatedfilename = Path.Combine(Application.dataPath, "Testcases/evaluationData_Mistral.json");
    ...
    private void SetupBarChart()
    {
        ...
        foreach (var data in evaluationdataList.dataList)
        {
            i++;
            barChart.AddXAxisData(i.ToString());
            float avg = float.Parse(data.MistralAvgTime);
