...
public class GeminiAutomatedTesting : MonoBehaviour
{
    [System.Serializable]
    ...
    [Header("Agents")]
    [SerializeField] private GeminiAgent chatgptAgent;
    [SerializeField] private GeminiAgent geminiAgent;
    [SerializeField] private GeminiAgent claudeAgent;
    [SerializeField] private GeminiAgent deepSeekAgent;
    [SerializeField] private GeminiAgent mistralAgent;
    ...
    void Start()
    {
        evaluatedfilename = Path.Combine(Application.dataPath, "Testcases/evaluationData_Gemini.json");
    ...
    private void SetupBarChart()
    {
        ...
        foreach (var data in evaluationdataList.dataList)
        {
            i++;
            barChart.AddXAxisData(i.ToString());
            float avg = float.Parse(data.GeminiAvgTime);
